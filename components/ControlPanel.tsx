...
export const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="space-y-4 md:space-y-6 p-3 md:p-6 pb-8 md:pb-6">
      {/* Point Generation */}
      <div className="space-y-2 md:space-y-3">
        <h3 className="text-base md:text-lg font-semibold text-gray-800 dark:text-gray-200">Point Generation</h3>
        ...
        <button
          ...
          className="w-full px-4 py-3 md:py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors flex items-center justify-center gap-2 touch-manipulation text-sm md:text-base"
        >
          <Sliders size={18} />
      ...
      {/* PSO Parameters */}
      <div className="space-y-2 md:space-y-3">
        <h3 className="text-base md:text-lg font-semibold text-gray-800 dark:text-gray-200">PSO Parameters</h3>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-3 md:py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-800 dark:text-gray-200 text-sm md:text-base touch-manipulation"
          />
        </div>
      </div>
      ...
      <div className="space-y-2 md:space-y-3">
        <h3 className="text-base md:text-lg font-semibold text-gray-800 dark:text-gray-200">Visualization</h3>
        
        <div className="flex items-center justify-between py-1">
          <span className="text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300">Show Particles</span>
          <button
          ...
          >
            <span
              className={`inline-block h-5 w-5 md:h-4 md:w-4 transform rounded-full bg-white transition-transform ${
                showParticles ? 'translate-x-6 md:translate-x-6' : 'translate-x-1'
              }`}
            />
          </button>
        </div>
        ...
        <div className="flex items-center justify-between py-1">
          <span className="text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300">Show Global Best Path</span>
          <button
          ...
          >
            <span
              className={`inline-block h-5 w-5 md:h-4 md:w-4 transform rounded-full bg-white transition-transform ${
                showGlobalBest ? 'translate-x-6 md:translate-x-6' : 'translate-x-1'
              }`}
            />
          </button>
        </div>
      ...
      <div className="space-y-2">
        <button
          ...
          className={`w-full px-4 py-3 md:py-3 ${
            isRunning && !isPaused ? 'bg-yellow-500 hover:bg-yellow-600' : 'bg-green-500 hover:bg-green-600'
          } text-white rounded-lg transition-colors flex items-center justify-center gap-2 font-semibold text-sm md:text-base touch-manipulation`}
        >
          {isRunning && !isPaused ? (
            <>
              <Pause size={20} />
        ...
        <button
          onClick={onReset}
          className="w-full px-4 py-3 md:py-3 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors flex items-center justify-center gap-2 font-semibold text-sm md:text-base touch-manipulation"
        >
          <RotateCcw size={20} />
          Reset Simulation
        </button>
